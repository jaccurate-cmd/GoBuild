...
const _CUT_OP         := preload("res://addons/go_build/mesh/operations/cut_operation.gd")
...
const _CUT_CTRL       := preload("res://addons/go_build/core/go_build_cut_controller.gd")
const _CUT_OVERLAY    := preload("res://addons/go_build/core/go_build_cut_overlay.gd")
